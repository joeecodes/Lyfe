...
class Help(commands.Cog):
    ...
    async def help(self, ctx, section=None):
        if section is None:
            ...
            embed.add_field(name=f"`{self.bot.prefix}8ball (question)`", value="Ask the magic 8ball a question!", inline=False)
